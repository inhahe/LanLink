...
///
/// The location is supplied by the caller rather than computed here: the desktop
/// keeps it under %LOCALAPPDATA%\LanLink\, mobile under the app data directory
/// MAUI hands out.  That was the only thing the two copies of this file ever
/// disagreed about.
/// </summary>
public sealed class MessageStore
{
    ...
    /// <summary>Where this instance was loaded from, and will save back to.</summary>
    [System.Text.Json.Serialization.JsonIgnore]
    public string StorePath { get; set; } = "";

    public static MessageStore Load(string storePath)
    {
        try
        {
        ...
        return new MessageStore { StorePath = storePath };
    }
